...
final Color inActiveBar = Color(0xffffffff);
final Color activeBar = Color(0xffffffff);
...
final TextStyle titleStyleItem = TextStyle(
    fontSize: 13, fontWeight: FontWeight.bold, color: kBlackColor, height: 1.6);
