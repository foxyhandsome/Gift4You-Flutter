...
class DeatilGift extends StatefulWidget {
  final int category;
  final int gender;
  ...
  @override
  State<DeatilGift> createState() => _DeatilGiftState();
}

class _DeatilGiftState extends State<DeatilGift> {
  final dio = Dio();
  List<ProductList> productData = [];
  productload() async {
    final response = await dio.post('${host}/get-recommend-product', data: {
      "category_id": widget.category,
      "gender_id": widget.gender,
      "sday_id": widget.specialday
    });
